...
phy_unemploy_income_0na$avgerage_physician = round(phy_unemploy_income_0na$polulation / (phy_unemploy_income_0na$count + 1))
...
final_data2_rm4$sentiment <- as.factor(ifelse(final_data2_rm4$Star_Rating_Current > 4,1,0))
